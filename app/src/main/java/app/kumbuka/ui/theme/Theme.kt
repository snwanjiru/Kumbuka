...
object KumbukaColors {
    val Primary            = Color(0xFF0B1C30)  // deep navy-black
    val OnPrimary          = Color(0xFFFFFFFF)
    val PrimaryContainer   = Color(0xFF0B1C30)  // used as dark button bg
    val OnPrimaryContainer = Color(0xFF7A899B)

    val Secondary          = Color(0xFFBA1A1A)  // red accent
